    ...
    return (
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            {clicked ?
                ...
                :
                <button type="button" onClick={showConfirmacao} className="cursor-pointer bg-red-700 hover:bg-red-800 focus:ring-4 rounded-lg text-m text-white font-bold  px-5 py-2.5 me-2 mb-2">Desativar {nomeEntidade}</button>
            }
        </div>)
