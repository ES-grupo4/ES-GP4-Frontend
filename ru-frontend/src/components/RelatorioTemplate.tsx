		...
		<Document title={`RelatorioRU-[mesSelecionado][anoSelecionado].pdf`}>
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.section}>
					...
					<View style={styles.row}>
						...
						<Text>
							{(data.faturamento_bruto_mensal / 100)
								.toFixed(2)
								.replace(".", ",")}
						</Text>
					</View>
			...
			<Page size="A4" style={styles.page}>
				...
				<View>
					...
					<Text>
						Quantidade de refeições adquiridas no mês por categoria de graduação
						dos clientes alunos:
					</Text>
					<View style={styles.subRow}>
						<Text>- Em Graduação:</Text>
					...
					<Text>
						Quantidade de refeições adquiridas no mês por tipo de cliente:
					</Text>
					<View style={styles.subRow}>
						<Text>- Alunos:</Text>
