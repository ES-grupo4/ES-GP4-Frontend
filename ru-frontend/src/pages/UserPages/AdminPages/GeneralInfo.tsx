    ...
    const fetchData = async () => {
      try {
        ...
        setCurrentInfo({
          ...
          preco_meia_almoco: converterParaReal(parseInt(info.preco_meia_almoco ?? '', 10)),
          preco_jantar: converterParaReal(parseInt(info.preco_jantar ?? '', 10)),
          preco_meia_jantar: converterParaReal(parseInt(info.preco_meia_jantar ?? '', 10)),
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                      <div>
                        <label htmlFor='inicio_almoco' className='block text-sm text-gray-600 mb-1'>
                          Início
                        </label>
                        <input
                          type='time'
                      ...
                      <div>
                        <label htmlFor='fim_almoco' className='block text-sm text-gray-600 mb-1'>
                          Fim
                        </label>
                        <input
                          type='time'
                  ...
                  <div>
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                      <div>
                        <label htmlFor='inicio_jantar' className='block text-sm text-gray-600 mb-1'>
                          Início
                        </label>
                        <input
                          type='time'
                      ...
                      <div>
                        <label htmlFor='fim_jantar' className='block text-sm text-gray-600 mb-1'>
                          Fim
                        </label>
                        <input
                          type='time'
