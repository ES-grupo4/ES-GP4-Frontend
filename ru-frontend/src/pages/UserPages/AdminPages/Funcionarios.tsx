...
export default function Funcionarios() {
    ...
    const [table, setTable] = useState({ tableHtml: <div></div>, tableData: [
        {
            Nome:"KIM KITSURAGI",
            CPF:"111111111-11",
    ...
    const handleSearch = () => { // Realiza busca com base na entrada
    ...
    return (
        <div className="p-4 sm:ml-64">
            <div className="group flex">
                ...
                <button className="bg-green-700 hover:bg-green-950 rounded-xl h-15 w-15 mx-4 my-2 cursor-pointer" type="button" onClick={handleSearch}>
            ...
            <div>
                <form className="flex items-center w-2/3 mx-auto">
                    ...
                    <div className="relative w-full">
                        <input type="text" id="simple-search" className="h-13 bg-white border border-gray-300 text-gray-900 text-m rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Pesquisar funcionário..." required />
                    </div>
                    <button type="submit" className="p-4 ms-2 text-white bg-blue-700 rounded-full border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 cursor-pointer">
