...
export default function AdminPages({
	...
	return (
		<Routes>
			...
			<Route
				path="/administradores/adicionar"
				element={<AdicionarAdministrador />}
			/>
			<Route
				path="/administradores/editar/:id"
				element={<EditarAdministrador setLogged={setLogged} />}
			/>
			...
			<Route
				...
				element={<EditarFuncionario setLogged={setLogged} />}
			/>
