  ...
  return (
    <div className='p-4 sm:ml-64'>
      <div className='group flex'>
        ...
        <Link
          to={UrlRouter.usuario.clientes.adicionar}
      ...
      <EntityTable
        tableData={data}
        columns={['id', 'nome', 'cpf', 'matricula', 'tipo', 'tipo_graduacao', 'bolsista']}
        url={UrlRouter.usuario.clientes.editar.split(':')[0]}
        hasChart={true}
        chartUrl={UrlRouter.usuario.clientes.detalhes.split(':')[0]}
        page={page}
        total_pages={pageQtd}
        prev={prev}
        next={next}
