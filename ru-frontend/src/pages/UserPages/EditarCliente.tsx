...
export default function EditarCliente() {
    ...
    if (id != null) {
      ...
      if (clientes.length !== 0) {
        setClienteData({
          ...
          matricula: clientes[0].matricula,
  ...
  const onChangeName = (e: React.ChangeEvent<any>) => {
    setClienteData({
      ...
      tipoGraduacao: clienteData.tipoGraduacao,
      bolsista: clienteData.bolsista,
    })
  }
      ...
      {found ? (
        <div className='bg-white mx-auto my-25 p-5 w-7/10 h-100 rounded-lg'>
          <p className='text-2xl'>
            <span className='font-bold'>CPF:</span> {clienteData.cpf}
          </p>
          <p className='text-2xl'>
          ...
          <div className='flex space-x-4 my-5'>
            <div className='inline-block relative w-32'>
              <label htmlFor='matricula' className='block text-md font-bold mb-1'>
                Tipo de Cliente:
              </label>
              <select
